...
class Sensors_Temp : public Adafruit_Sensor {
public:
  /** @brief Create an Adafruit_Sensor compatible object for the temp sensor
      @param parent A pointer to the BME280 class */
  Sensors_Temp(Sensors *parent) { _theBME280 = parent; }
  bool getEvent(sensors_event_t *);
  void getSensor(sensor_t *);

private:
  int _sensorID = 280;
  Sensors *_theBME280 = NULL;
};

/** Adafruit Unified Sensor interface for pressure component of BME280 */
class Sensors_Pressure : public Adafruit_Sensor {
public:
  /** @brief Create an Adafruit_Sensor compatible object for the pressure sensor
      @param parent A pointer to the BME280 class */
  Sensors_Pressure(Sensors *parent) { _theBME280 = parent; }
  bool getEvent(sensors_event_t *);
  void getSensor(sensor_t *);
...
class Sensors_Humidity : public Adafruit_Sensor {
public:
  /** @brief Create an Adafruit_Sensor compatible object for the humidity sensor
      @param parent A pointer to the BME280 class */
  Sensors_Humidity(Sensors *parent) { _theBME280 = parent; }
  bool getEvent(sensors_event_t *);
  void getSensor(sensor_t *);
...
public:
  ...
  */
  ...
  // constructors
  Sensors();
  Sensors(int8_t cspin, SPIClass *theSPI = &SPI);
  Sensors(int8_t cspin, int8_t mosipin, int8_t misopin, int8_t sckpin);
  ~Sensors(void);
...
protected:
  ...
  Sensors_Temp *temp_sensor = NULL;
  //!< Adafruit_Sensor compat temperature sensor component

  Sensors_Pressure *pressure_sensor = NULL;
  //!< Adafruit_Sensor compat pressure sensor component

  Sensors_Humidity *humidity_sensor = NULL;
